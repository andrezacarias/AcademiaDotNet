...
namespace GerenciamentoDeVendas {
    ...
    public partial class RhinoStore_DBDataSet : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClienteRow AddClienteRow(int idCliente, string nomeCompleto, string email, string cpf, string celular) {
...
namespace GerenciamentoDeVendas.RhinoStore_DBDataSetTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([idCliente], [nomeCompleto], [email], [cpf], [celula" +
                "r]) VALUES (@idCliente, @nomeCompleto, @email, @cpf, @celular);\r\nSELECT idClient" +
                "e, nomeCompleto, email, cpf, celular FROM Cliente WHERE (idCliente = @idCliente)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [idCliente] = @idCliente, [nomeCompleto] = @nomeCompleto, [email] = @email, [cpf] = @cpf, [celular] = @celular WHERE (([idCliente] = @Original_idCliente) AND ([nomeCompleto] = @Original_nomeCompleto) AND ([email] = @Original_email) AND ([cpf] = @Original_cpf) AND ([celular] = @Original_celular));
SELECT idCliente, nomeCompleto, email, cpf, celular FROM Cliente WHERE (idCliente = @idCliente)";
        ...
        public virtual int Fill(RhinoStore_DBDataSet.ClienteDataTable dataTable) {
        ...
        public virtual RhinoStore_DBDataSet.ClienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RhinoStore_DBDataSet.ClienteDataTable dataTable = new RhinoStore_DBDataSet.ClienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RhinoStore_DBDataSet.ClienteDataTable dataTable) {
        ...
        public virtual int Insert(int idCliente, string nomeCompleto, string email, string cpf, string celular) {
        ...
        public virtual int Update(int idCliente, string nomeCompleto, string email, string cpf, string celular, int Original_idCliente, string Original_nomeCompleto, string Original_email, string Original_cpf, string Original_celular) {
        ...
        public virtual int Update(string nomeCompleto, string email, string cpf, string celular, int Original_idCliente, string Original_nomeCompleto, string Original_email, string Original_cpf, string Original_celular) {
            return this.Update(Original_idCliente, nomeCompleto, email, cpf, celular, Original_idCliente, Original_nomeCompleto, Original_email, Original_cpf, Original_celular);
        }
    }
