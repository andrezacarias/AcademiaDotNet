...
do
{
    ...
    switch (opcao)
    {
        case "1":
            ...
            Console.WriteLine("Adicionando itens à lista, aguarde!");
        ...
        case "2":
            ...
            {
                Console.WriteLine("Exibindo a lista de valores de glicemia");
                for (int i = 0; i < listaGlicemia.Count; i++)
                {
                    Console.WriteLine(listaGlicemia[i].ToString());
                }
        ...
        case "3":
            ...
            else
            {
                ...
                Console.WriteLine($"O valor mínimo da lista é: {min}");
                Console.WriteLine($"O valor máximo da lista é: {max}");
            }
            break;
        case "4":
