    ...
    public class VendaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Venda != null ? 
                          ...
                          Problem("Entity set 'PizzaDoMarioContext.Venda'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdVenda,IdCliente,valorTotal,dataCompra")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVenda,IdCliente,valorTotal,dataCompra")] Venda venda)
        {
            if (id != venda.IdVenda)
            {
                return NotFound();
