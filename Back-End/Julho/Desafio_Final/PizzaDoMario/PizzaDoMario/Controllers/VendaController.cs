...
namespace PizzaDoMario.Controllers
{
    public class VendaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdVenda,ClienteId,IdProduto,valorTotal,dataCompra,quantidade")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVenda,ClienteId,IdProduto,valorTotal,dataCompra,quantidade")] Venda venda)
        {
            if (id != venda.IdVenda)
            {
                return NotFound();
